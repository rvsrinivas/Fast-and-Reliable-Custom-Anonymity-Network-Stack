...
//    printf("Remote MAC for device %s is %.2X-%.2X-%.2X-%.2X-%.2X-%.2X \n", device_name, dest_mac[0] , dest_mac[1] , dest_mac[2] , dest_mac[3] , dest_mac[4] , dest_mac[5]);
    node1_mac[0] = 0x00; node1_mac[1] = 0x15; node1_mac[2] = 0x17; node1_mac[3] = 0x5d; node1_mac[4] = 0x17; node1_mac[5] = 0x0c;
    node2_mac[0] = 0x00; node2_mac[1] = 0x15; node2_mac[2] = 0x17; node2_mac[3] = 0x5d; node2_mac[4] = 0x13; node2_mac[5] = 0x6c;
    node3_mac[0] = 0x00; node3_mac[1] = 0x15; node3_mac[2] = 0x17; node3_mac[3] = 0x5d; node3_mac[4] = 0x33; node3_mac[5] = 0x64;
}
...
//    port = atoi(argv[3]);
    ...
    while (seqNum < no_of_packets) {
		...
		encrypt((const u_char *)packet, packetOut_e, pktlen);
        //print_rl_packet(stdout, packetOut_e, pktlen);
